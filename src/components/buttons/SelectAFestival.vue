...
<template>
    <div>
        ...
        <div class="relative inline-block group text-skin-inverted border-2 border-skin-muted">
            <ButtonShadow />
            <select name="select-a-festival" class="w-full h-full p-[9.5px] bg-skin-accent cursor-pointer outline-none" @change="this.$emit('festivalSelect')" v-model="festival">
